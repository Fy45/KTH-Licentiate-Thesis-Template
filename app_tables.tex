...
\tablefirsthead{\hline
				\multirow{5}{1.5cm}{\textbf{Project}\\}&
				\multirow{5}{4cm}{\textbf{Description}\\}&
				\multirow{5}{1.3cm}{\textbf{Scheme}\\}&
				\multirow{5}{1.5cm}{\textbf{Consensus}\\}&
				\multirow{5}{1.5cm}{\textbf{Type}\\}&
				\multirow{5}{2.2cm}{\textbf{Interoperability}\\}&
				\multirow{5}{1.8cm}{\textbf{Application}\\}& 
				\textbf{Compatibility with  traditional  ledger}
\\\hline}
\tablelasttail{\hline}
